import 'package:afazeresapp/model/afazer.dart';
import 'package:afazeresapp/util/db_ajudante.dart';
...
class _AfazeresTelaState extends State<AfazeresTela> {
  ...
  void _lidarComTexto(String text) async {
    ...
    Afazer afazer = Afazer(text, dataFormatada());
      ...
      content: Row(
        children: <Widget>[
          Expanded(
            ...
            autofocus: true,
            decoration:
                InputDecoration(labelText: "A fazer", icon: Icon(Icons.update)),
          ))
        ],
      ),
      actions: <Widget>[
